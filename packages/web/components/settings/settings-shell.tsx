...
// Re-export the shared accordion under its legacy settings-specific
// names so existing imports (`SettingsAccordion`, `SettingsAccordionItem`)
// keep working without a big sweep. New code should import directly
// from `@/components/ui/accordion`.
export { Accordion as SettingsAccordion };
export type { AccordionItem as SettingsAccordionItem };
